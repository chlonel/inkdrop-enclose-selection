...
class Editor extends event_kit_1.Disposable {
    constructor(cm) {
        ...
        if (cm.somethingSelected())
            (0, has_selection_control_1.addHasSelectionsClass)(this.cm);
    ...
    registerCommands() {
        ...
        const handlers = Object.entries(enclose_selection_1.ENCLOSURE_MAP).reduce((acc, [name, { left, right }]) => {
            ...
            return Object.assign(Object.assign({}, acc), { [commandName]: () => (0, enclose_selection_1.encloseSelections)(this.cm, left, right) });
        }, {});
    ...
    destroy() {
        ...
        (0, has_selection_control_1.removeHasSelectionsClass)(this.cm);
    }
}
